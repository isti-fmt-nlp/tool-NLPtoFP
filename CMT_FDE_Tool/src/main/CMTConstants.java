...
public class CMTConstants {
	...
	private static final String topSaveFolder = topSaveFolderParent+"/CMT_FDE_Workspace";

	/*Windows Versions*/
	/** top level save folder for both tools*/
	private static final String topSaveFolder_Win = topSaveFolderParent+"\\CMT_FDE_Workspace";
